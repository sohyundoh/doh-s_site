...
import myface from "../../assets/image/myface.png";
import './Aboutme.css'
...
const Aboutme = () =>{
    return(
        <div>
            ...
            <p className="Contents">In 2022, Paris, Giverny, Vesilles, France</p>
            <p className="Contents">In 2022, Bruxelles, Belgium</p>
